...
const relayCliPath = resolve(process.cwd(), 'node_modules', 'orbitdb-relay-pinner', 'dist', 'cli.js');
...
const env = {
  ...
  METRICS_PORT: process.env.METRICS_PORT || process.env.HTTP_PORT || process.env.RELAY_HTTP_PORT || '3001',
